...
public class Test {
    ...
    public void initialisation() {
        ...
        critere1.put(Critere.GUEST_ANIMAL_ALLERGY, "false");
        critere1.put(Critere.HOST_HAS_ANIMAL, "false");
        critere1.put(Critere.HOST_FOOD, "vegetarien");
        critere1.put(Critere.GUEST_FOOD_CONSTRAINT, "vegetarien");
        critere1.put(Critere.HOBBIES, "sports");
        critere1.put(Critere.GENDER, "M");
        critere1.put(Critere.PAIR_GENDER, "F");

        Map<Critere, String> critere2 = new EnumMap<>(Critere.class);
        critere2.put(Critere.BIRTH_DATE, "2008-02-01");
        critere2.put(Critere.GUEST_ANIMAL_ALLERGY, "false");
        critere2.put(Critere.HOST_HAS_ANIMAL, "false");
        critere2.put(Critere.HOST_FOOD, "vegetarien");
        critere2.put(Critere.GUEST_FOOD_CONSTRAINT, "vegetarien");
        critere2.put(Critere.HOBBIES, "sports");
        critere2.put(Critere.GENDER, "F");
        critere2.put(Critere.PAIR_GENDER, "M");

        Map<Critere, String> critereDifferent = new EnumMap<>(Critere.class);
        critereDifferent.put(Critere.BIRTH_DATE, "2000-01-01");
        critereDifferent.put(Critere.GUEST_ANIMAL_ALLERGY, "true");
        critereDifferent.put(Critere.HOST_HAS_ANIMAL, "true");
        critereDifferent.put(Critere.HOST_FOOD, "meat");
        critereDifferent.put(Critere.GUEST_FOOD_CONSTRAINT, "vegetarien");
        critereDifferent.put(Critere.HOBBIES, "lire");
        critereDifferent.put(Critere.GENDER, "M");
        critereDifferent.put(Critere.PAIR_GENDER, "M");

        ado1 = new Adolescent("Corentin", "Chocraux", LocalDate.of(2008, 1, 1), "M", "France", critere1);
        ado2 = new Adolescent("Emily", "Paris", LocalDate.of(2008, 2, 1), "F", "France", critere2);
        adoDifferent = new Adolescent("Martin", "Morenville", LocalDate.of(2000, 1, 1), "M", "France", critereDifferent);
